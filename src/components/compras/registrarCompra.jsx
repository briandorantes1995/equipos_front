                                    ...
                                    {({ push, remove }) => (
                                        <>
                                            {values.articulos.map((item, index) => {
                                                ...
                                                return (
                                                    <div key={index} className="d-flex align-items-end mb-3" style={{ gap: "10px" }}>
                                                        {/* Artículo */}
                                                        <CustomLista
                                                            label="Artículo"
                                                        ...
                                                        <MDBBtn color="danger" onClick={() => remove(index)} type="button">-</MDBBtn>
                                                    </div>
                                                );
                                            })}
                                            ...
                                            <MDBBtn
                                                color="success"
                                                type="button"
                                                onClick={() => push({ articulo: "", categoria: "", proveedor: "", cantidad: "", precio_unitario: "" })}
                                            >
                                                + Agregar artículo
                                            </MDBBtn>
                                        </>
